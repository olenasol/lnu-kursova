...
\chapter{3. Дерево, Cluster Tree і Block Cluster Tree.}
	...
	\end{enumerate}
	\subsection{Стандартна допустимість}
	\hspace{0.8cm} Стандартна умова допустимості була вперше описана в класичній побудові $\mathcal{H}$-матриць, де вона застосовується для розподілу, здебільшого для проблем, що вирішуються за допомогою BEM.
	\begin{Def}
